///  CTAA  SPS  V1.9 Copyright Livenda Labs Pty Ltd 2019
...
float4 frag (v2f i) : COLOR
{
 ...
 //EYUIAY IHIFAU EN  NFAIUENFN NAFIEUHIU NOAIUFHWEKJNA N FANLEFUHALNF ADKFNFAIUH NFAIKHA NFANIAFNKJN NIAEKKEUR
        ...
        grdiccx = saturate(pow(grdiccx, 1.1)*2);
       
        InExxSs49SS = 8;//grdiccx*20;
 ...
 //EYUIAY IHIFAU EN  NFAIUENFN NAFIEUHIU NOAIUFHWEKJNA N FANLEFUHALNF ADKFNFAIUH NFAIKHA NFANIAFNKJN NIAEKKEUR	
	...
	float	_TdjeKfhjuewennsjdE = 1/(grdiccx*50*_ControlParams.y);
