...
Shader "Custom/ASE_PBR_Craft_Metallic"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode233 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
			o.Metallic = tex2DNode233.r;
...
/*ASEBEGIN
Version=17500
181;23;1541;1005;776.7083;291.9664;1;True;False
...
WireConnection;0;3;233;1
WireConnection;0;4;7;0
WireConnection;0;5;229;2
ASEEND*/
//CHKSM=E25D233312ABE3E774C71EE3271A48A6B18E5FBE